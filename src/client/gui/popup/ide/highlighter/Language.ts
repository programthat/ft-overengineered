...
interface LanguageData {
	readonly keyword: WordMap;
	readonly builtin: WordMap;
	readonly libraries: { readonly [lib: string]: WordMap | undefined };
}

const enumLibrary: { [name: string]: string } = {};
for (const enumItem of Enum.GetEnums()) {
	enumLibrary[tostring(enumItem)] = "Enum";
}
